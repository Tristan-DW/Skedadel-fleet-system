...
if (USE_SQL_DATABASE) {
  ...
  console.log('  Password First Char:', dbPass.charAt(0));
  console.log('  Password Last Char:', dbPass.charAt(dbPass.length - 1));
  console.log('  Password contains "|":', dbPass.includes('|'));
  console.log('  Password contains ",":', dbPass.includes(','));
